#!/usr/bin/env Rscript
# =============================================================================
# plot_returns_with_eth_price_60_ma.R
#
# Description:
#   Same as plot_returns_with_eth_price.R but using a 60-day moving
#   average of the wETH price to smooth short-term volatility.
#
# Input:
#   CSV with per-block return statistics + ETH price CSV.
#
# Output:
#   Single PDF (default: ../graphics/returns_with_eth_price_60_ma.pdf).
# =============================================================================
...
option_list <- list(
  ...
  make_option("--out-pdf",    type = "character", default = "../graphics/returns_with_eth_price_60_ma.pdf"),
...
# Get monthly price: take the MA60 value closest to each block_date
...
p <- ggplot() +
  ...
  scale_y_continuous(
    ...
    sec.axis = sec_axis(
      ~ (. - offset) / scale_factor,
      name   = "wETH price — 60-day moving avg (USD)",
